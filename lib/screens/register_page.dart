  ...
  void _register() async {
    ...
    setState(() {
        ...
        if (_formKey.currentState!.validate()) {
          ...
          if (result) {
            String? profilePicture = await _storageService.uploadImages(file: _profileImage!, uid: _authService.user!.uid);
            
            if(profilePicture!=null){
              await _databaseService.createUserProfile(userProfile: UserProfile(uid: _authService.user!.uid, fullName: fullname, profilePictureUrl: profilePicture, userName: username));
            ...
            _alertService.showToast(text: "Registration Successful", icon: Icons.check_circle);
          }
          else{
